    ...
    <div class="et-banner-slider swiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div
                    class="bg-no-repeat bg-cover bg-[url('../assets/img/banner-bg-1.jpg')] bg-center pt-[clamp(150px,17.3vw,333px)] pb-[clamp(120px,22vw,422px)] text-white relative overflow-hidden z-[1] before:content-normal before:absolute before:inset-0 before:bg-etBlue/40 before:-z-[1]">
                        ...
                        <div
                            ...
                            <div class="left relative z-[20] w-[55%] md:w-full">
                                ...
                                <h1
                                    ...
                                    NaginiVidyalaya
                                    <span class="font-normal tracking-tighter">
                                        Matric Hr Sec School </span>
                                </h1>
                                ...
                                <div class="et-banner-btns flex flex-wrap items-center gap-[20px]">
                                    ...
                                    <a href="#"
                                        class="et-btn bg-white inline-flex items-center justify-center gap-x-[13px] h-[45px] px-[15px] text-etBlue font-normal text-[17px] rounded-full">View
                                        More</a>
                                </div>

                                <!-- vectors -->
                                <div class="et-banner-vectors">
                                    <div class="absolute left-[457px] bottom-[calc(100%+40px)]">
                                        <img src="assets/img/banner-vector.png" alt="vector"
                                            class="w-[45px] h-[45px]" />
                                    </div>
                                    <div class="absolute bottom-0 right-[6px]">
                                        <img src="assets/img/banner-vector.png" alt="vector"
                                            class="w-[21px] h-[21px]" />
                                    </div>
                                </div>
                            ...
                            <!-- <div class="et-banner-video-btn w-[40%] md:w-full shrink-0">
                                    <a href="https://youtu.be/uUzWR1ECaKE?si=Kd1iC89HGJxhCoLj"
                    ...
                    <!-- bottom title -->
                    <!-- <span class="et-banner-bottom-title text-[clamp(30px,13vw,250px)] font-bold text-white/10 text-center block absolute bottom-[40px] left-0 w-full">Nagini Vidyalaya</span> -->
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div
                    class="bg-no-repeat bg-cover bg-[url('../assets/img/banner-bg-2.jpg')] bg-center pt-[clamp(150px,17.3vw,333px)] pb-[clamp(120px,22vw,422px)] text-white relative overflow-hidden z-[1] before:content-normal before:absolute before:inset-0 before:bg-etBlue/40 before:-z-[1]">
                    <div class="mx-[15.5em] xxxl:mx-[10em] xxl:mx-[40px] xs:mx-[12px]">
                        <div
                            class="flex md:flex-col items-center justify-between gap-x-[30px] gap-y-[30px] md:grid-cols-1">
                            <div class="left relative z-[20] w-[55%] md:w-full">
            ...
            <div class="swiper-slide">
                <div
                    class="bg-no-repeat bg-cover bg-[url('../assets/img/banner-bg-3.jpg')] bg-center pt-[clamp(150px,17.3vw,333px)] pb-[clamp(120px,22vw,422px)] text-white relative overflow-hidden z-[1] before:content-normal before:absolute before:inset-0 before:bg-etBlue/40 before:-z-[1]">
                    <div class="mx-[15.5em] xxxl:mx-[10em] xxl:mx-[40px] xs:mx-[12px]">
                        <div
                            class="flex md:flex-col items-center justify-between gap-x-[30px] gap-y-[30px] md:grid-cols-1">
                            <div class="left relative z-[20] w-[55%] md:w-full">
    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <img src="assets/img/about 1.png" alt="image" class="shrink-0 rounded-[10px]" />
                <img src="assets/img/about-img-3.png" alt="image"
                ...
                <!-- video btn -->
                <div
                    class="absolute bottom-[50px] -left-[47px] lg:-left-[27px] md:-left-[47px] w-[180px] lg:w-[160px] aspect-square bg-[url('../assets/img/about-video-btn-bg.png')] text-center text-[22px] text-white z-[1] flex items-center justify-center before:absolute before:bg-etBlue/80 before:-z-[1] before:inset-0 after:bg-etBlack after:w-[47px] after:h-[30px] after:absolute after:top-[100%] after:left-0 after:-z-[2] after:skew-y-[30deg] after:-translate-y-[17px]">
                    <a href="https://youtu.be/uUzWR1ECaKE?si=Kd1iC89HGJxhCoLj" data-fslightbox="about-video"
            ...
            <div class="et-about__txt">
                ...
                <p class="mb-[30px] text-[16px] font-light text-etGray md:mb-[30px] rev-slide-up">
                    NaginiVidyalaya Matric Hr Sec School for the past 5 decades offers quality education with individual
                    care and social responsibility in the rural sector.
                </p>
                ...
                <div
                    ...
                    <!-- txt -->
                    <div>
                        <h6 class="font-medium text-[18px] text-black mb-[8px]">
                            Whence at the Conference
                        </h6>
                        <p class="text-[16px] font-light text-etGray">
                            Students have emerged with curriculum emphasizing on communicative skills, imaginative ideas
                            , technical knowledge who excel in their career chosen.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-x-[30px] gap-y-[16px] rev-slide-up">
                    <a href="about.php"
                        class="et-btn bg-etBlue inline-flex items-center justify-center gap-x-[13px] h-[45px] px-[15px] text-white font-normal text-[17px] rounded-full hover:!bg-black hover:!text-white">Read
                        more</a>
...
<div
    class="bg-[#EEF4FF] relative z-[1] after:absolute after:inset-0 after:bg-[url(../assets/img/features-bg.png)] after:bg-no-repeat after:bg-cover after:-z-[2] after:mix-blend-multiply after:pointer-events-none pb-[60px] xl:pb-[80px] md:pb-[60px] pt-[60px] xl:pt-[194px] md:pt-[174px]">
    <div
        ...
        <!-- cards -->
        <div class="grid grid-cols-2 md:grid-cols-3 sm:grid-cols-2 xxs:grid-cols-1 gap-[30px] lg:gap-[20px]">
            <!-- single card -->
            <div class="rounded-[20px] bg-white overflow-hidden group flex flex-row-reverse items-start">
                ...
                <div class="px-[30px] xxl:px-[20px] py-[23px] xxl:py-[18px]">
                    ...
                    <p class="font-light text-etGray text-[16px]">
                        First private school in the area to provide inclusive and innovative education to the rural
                        community inculcating cultural and traditional values.
                    </p>
                </div>
            </div>
            ...
            <div class="rounded-[20px] bg-white overflow-hidden group flex flex-row-reverse items-start">
                ...
                <div class="px-[30px] xxl:px-[20px] py-[23px] xxl:py-[18px]">
                    ...
                    <p class="font-light text-etGray text-[16px]">
                        Building on 49 years of educational excellence to empower young minds with knowledge, values and
    ...
    <div class="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full rev-slide-up"
        ...
        <div
            ...
            <div class="et-single-stat text-white">
                <h5 class="number font-semibold text-[55px]">1000+</h5>
                <h6 class="font-medium text-[16px]">No of Students</h6>
            </div>
            <!-- single stat -->
            <div class="et-single-stat text-white">
                <h5 class="number font-semibold text-[55px]">25+</h5>
                <h6 class="font-medium text-[16px]">Years of Experience</h6>
            </div>
            <!-- single stat -->
            <div class="et-single-stat text-white">
                <h5 class="number font-semibold text-[55px]">70+</h5>
                <h6 class="font-medium text-[16px]">Teachers</h6>
            </div>
            <!-- single stat -->
            <div class="et-single-stat text-white">
                <h5 class="number font-semibold text-[55px]">70%</h5>
                <h6 class="font-medium text-[16px]">Results</h6>
            </div>
        </div>

        <h2
            class="et-section-title anim-text !text-white text-center max-w-[55%] md:max-w-[65%] sm:max-w-full mx-auto mt-[30px] mb-[40px]">
            <div class="word" style="display: inline-block;">
                <div class="char"
                    style="display: inline-block; translate: none; rotate: none; scale: none; transform: translate(0%, 0px); opacity: 1;">
                    N</div>
                <div class="char"
                    style="display: inline-block; translate: none; rotate: none; scale: none; transform: translate(0%, 0px); opacity: 1;">
                    a</div>
...
<section class="et-speakers pt-[60px] pb-[80px] lg:py-[80px] md:py-[60px] relative overflow-hidden">
    <div class="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
        ...
        <div
            ...
            <div class="right">
                <div class="et-speakers-slider-nav flex gap-[16px] sm:gap-[12px]">
                    <button
                        class="prev border border-[#D9D9D9] rounded-full w-[60px] sm:w-[50px] h-[60px] sm:h-[50px] text-[18px] text-etBlack hover:bg-etBlue hover:border-etbg-etBlue hover:text-white swiper-button-disabled"
                        disabled="" tabindex="-1" aria-label="Previous slide"
                        aria-controls="swiper-wrapper-468d48bfb837fb4c" aria-disabled="true">
                    ...
                    <button
                        ...
                        tabindex="0" aria-label="Next slide" aria-controls="swiper-wrapper-468d48bfb837fb4c"
                        aria-disabled="false">
        ...
        <!-- slider -->
        <div
            class="et-speakers-slider swiper swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden">
            <div class="swiper-wrapper" id="swiper-wrapper-468d48bfb837fb4c" aria-live="polite">
                <!-- single speaker -->
                <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active"
                    role="group" aria-label="1 / 4" style="width: 372px; margin-right: 30px;">
                    <div class="et-speaker bg-white rounded-[16px] relative z-[1] group">
                        ...
                        <div
                            ...
                            <h4 class="et-speaker-name font-medium text-[24px] mb-[3px]"><a
                                    href="team-member-details.html" class="hover:text-black">Dummy Content</a></h4>
                            <h6 class="et-speaker-label font-normal text-[16px]">Dummy Content</h6>
                        </div>
                    </div>
                </div>

                <!-- single speaker -->
                <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-next" role="group"
                    aria-label="2 / 4" style="width: 372px; margin-right: 30px;">
                ...
                <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible" role="group"
                    aria-label="3 / 4" style="width: 372px; margin-right: 30px;">
                    <div class="et-speaker bg-white rounded-[16px] relative group">
                        <div
                            class="et-speaker-img before:absolute before:inset-0 before:bg-gradient-to-t before:from-etBlue before:to-transparent before:opacity-0 before:transition before:duration-[400ms] before:z-[1] group-hover:before:opacity-100">
                ...
                <!-- single speaker -->
                <div class="swiper-slide" role="group" aria-label="4 / 4" style="width: 372px; margin-right: 30px;">
                    <div class="et-speaker bg-white rounded-[16px] relative group">
                        <div
                            class="et-speaker-img before:absolute before:inset-0 before:bg-gradient-to-t before:from-etBlue before:to-transparent before:opacity-0 before:transition before:duration-[400ms] before:z-[1] group-hover:before:opacity-100">
                            <img src="assets/img/t1.png" alt="speaker image"
...
<section class="grid grid-cols-4 lg:grid-cols-3 sm:grid-cols-2">
    ...
    <div
        ...
        <a href="assets/img/g1.png" data-fslightbox="gallery"
    ...
    <div
        ...
        <a href="assets/img/g6.png" data-fslightbox="gallery"
            class="inline-flex items-center justify-center w-[64px] aspect-square rounded-full bg-white text-[25px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] opacity-0 group-hover:opacity-100 hover:text-etBlue">
            <i class="fa-plus fa-regular"></i>
        </a>
    ...
    <div
        ...
        <a href="assets/img/g2.png" data-fslightbox="gallery"
            class="inline-flex items-center justify-center w-[64px] aspect-square rounded-full bg-white text-[25px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] opacity-0 group-hover:opacity-100 hover:text-etBlue">
            <i class="fa-plus fa-regular"></i>
        </a>
    </div>
    ...
    <div
        ...
        <a href="assets/img/g3.png" data-fslightbox="gallery"
            class="inline-flex items-center justify-center w-[64px] aspect-square rounded-full bg-white text-[25px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] opacity-0 group-hover:opacity-100 hover:text-etBlue">
            <i class="fa-plus fa-regular"></i>
        </a>
    </div>
    ...
    <div
        ...
        <a href="assets/img/g4.png" data-fslightbox="gallery"
            class="inline-flex items-center justify-center w-[64px] aspect-square rounded-full bg-white text-[25px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] opacity-0 group-hover:opacity-100 hover:text-etBlue">
            <i class="fa-plus fa-regular"></i>
        </a>
    </div>
    ...
    <div
        ...
        <a href="assets/img/g5.png" data-fslightbox="gallery"
            class="inline-flex items-center justify-center w-[64px] aspect-square rounded-full bg-white text-[25px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] opacity-0 group-hover:opacity-100 hover:text-etBlue">
            <i class="fa-plus fa-regular"></i>
        </a>
    </div>
    ...
    <div
        ...
        <div>
            <h6 class="et-section-sub-title !text-white before:!bg-white anim-text">
                Gallery
            </h6>
            <span
                class="block text-white font-semibold text-[100px] leading-[0.86] mb-[13px] xxl:text-[80px] xl:text-[60px] md:!text-[50px] xs:!text-[45px] xs:!mb-[10px] anim-text">2025</span>
            <h2
                class="et-section-title !text-white !font-normal mb-[31px] xxl:!text-[40px] xl:!text-[35px] md:!text-[30px] md:mb-[21px] anim-text">
                NaginiVidyalaya Gallery
            </h2>
            <a href="gallery.html"
    ...
    <div
        ...
        <a href="assets/img/g7.png" data-fslightbox="gallery"
            class="inline-flex items-center justify-center w-[64px] aspect-square rounded-full bg-white text-[25px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] opacity-0 group-hover:opacity-100 hover:text-etBlue">
            <i class="fa-plus fa-regular"></i>
        </a>
    </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-1 gap-[30px]">
            ...
            <div
                ...
                <div class="relative">
                    <!-- <iframe
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31332.023414499414!2d76.83149877431639!3d11.000842400000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba85e57aed0dfc3%3A0xde6c9bc17ac3b993!2sNagini%20Vidyalaya%20Matric%20Higher%20Secondary%20School!5e0!3m2!1sen!2sin!4v1750230263505!5m2!1sen!2sin" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                        class="w-full h-[303px] rounded-tl-[20px] rounded-tr-[20px]"></iframe>

                    <div
                        class="absolute inset-[40px] top-auto flex rounded-[20px] overflow-hidden bg-white xxs:flex-col">
                        <img src="assets/img/map-img.png" alt="venue image" class="shrink-0 w-[50%] xxs:w-full">
            ...
            <div
                ...
                <div class="mb-[34px]">
                    ...
                    <h2 class="et-section-title !text-white mb-[18px] anim-text">
                        <div class="word" style="display: inline-block;">
                            <div class="char"
                                style="display: inline-block; translate: none; rotate: none; scale: none; transform: translate(0%, 0px); opacity: 1;">
                                G</div>
                    ...
                    <p class="text-[16px] text-white font-light mb-[25px]">NaginiVidyalaya Matric Hr Sec School for the past 5 decades offers quality education with individual care and social responsibility in the rural sector.</p>
                    <a href="#"
                        class="bg-etBlue border border-white rounded-full h-[45px] px-[15px] text-[17px] text-white inline-flex items-center justify-center hover:bg-white hover:text-etBlue">Contact Us</a>
                </div>

                <div class="rounded-tl-[20px] rounded-tr-[20px] overflow-hidden">
                    <img src="assets/img/map-teach.png" alt="Image">
                </div>
            </div>
        </div>
    </div>
