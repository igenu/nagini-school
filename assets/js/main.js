document.addEventListener("DOMContentLoaded", () => {
  ...
  const etHeaderSearchBtn = document.querySelector(
  ...
  // MOBILE MENU SIDEBAR
  const etMobileMenuOpenBtn = document.querySelector(
    ".et-mobile-menu-open-btn"
  );
  ...
  // auctions event tab
  const auctionTabButtons = document.querySelectorAll(
    ".auctions-event-tab-nav"
  );
