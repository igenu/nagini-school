            ...
            <div
                ...
                <div class="et-footer-about max-w-[295px] lg:max-w-none md:max-w-[300px] xs:max-w-full">
                    ...
                    <div
                        ...
                        <a href="#" class="hover:text-white hover:bg-etBlue hover:border-etBlue"><i
                ...
                <!-- widget -->
                <div class="et-footer-widget shrink-0 xs:grow">
                    <h5 class="text-[20px] font-semibold mb-[16px]">
                        Useful <span class="text-etBlue">Links</span>
                    </h5>
                ...
                <div class="et-footer-widget shrink-0 max-w-[318px] xs:max-w-full xs:grow">
                    <h5 class="text-[20px] font-semibold mb-[16px]">
                        Upcoming <span class="text-etBlue">Events</span>
                    </h5>
